...
CACHE_DIR = os.path.expanduser("~/.cache/torchstream/datasets/charades/")
DOWNLOAD_SERVER_PREFIX = (
    "a21:/home/eecs/zhen/video-acc/download/"
    "torchstream/datasets/charades/"
)
...
class Charades(VisionDataset):
    ...
    def __init__(self, root, train, split=1,
        ...
        super(Charades, self).__init__(root=root,
                                       transform=transform,
