...
DOWNLOAD_SRC_DIR = "torchstream/datasets/sthsthv1/"

CACHE_DIR = os.path.expanduser("~/.cache/torchstream/datasets/sthsthv1/")


class SomethingSomethingV1(VisionDataset):
    ...
    def __init__(self, root, train, class_to_idx=None, ext="jpg",
        ...
        if not os.path.exists(datapoint_filepath):
            print("downloading Something-Something-V1 datapoints...")
